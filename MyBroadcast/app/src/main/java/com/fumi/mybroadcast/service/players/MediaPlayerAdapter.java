...
package com.fumi.mybroadcast.service.players;
...
import com.fumi.mybroadcast.service.PlaybackInfoListener;
import com.fumi.mybroadcast.service.PlayerAdapter;
...
public final class MediaPlayerAdapter extends PlayerAdapter {
    ...
    public void playFromMedia(MediaMetadataCompat metadata) {
        ...
        playFile(MusicLibrary.getMusicStorageRef(mediaId));
    }
    ...
    private void playFile(StorageReference ref) {
        boolean mediaChanged = (ref == null || !ref.equals(mRef));
        if (mCurrentMediaPlayedToCompletion) {
            // Last audio file was played to completion, the resourceId hasn't changed, but the
            // player was released, so force a reload of the media file for playback.
            mediaChanged = true;
                    ...
                    try {
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            try {
                                ...
                                throw new RuntimeException("Failed to open firebase storage: " + mRef.getName(), e);
                            }
