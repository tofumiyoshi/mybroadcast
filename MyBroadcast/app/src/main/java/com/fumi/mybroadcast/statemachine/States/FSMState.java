...
**/
package com.fumi.mybroadcast.statemachine.States;

import com.fumi.mybroadcast.statemachine.Action.FSMAction;
import com.fumi.mybroadcast.statemachine.Common.CustomXMLReader;
...
public class FSMState implements java.io.Serializable {
    ...
    private HashMap<String, String> _transitionMap;
    private HashMap<String, FSMTransitionInfo> _transitions;
     ...
     */
    public FSMState(String state, HashMap<String, String> map){
        this._curState = state;
     ...
     * @param action
     */
    public void addMessages(String message, String action) {
    ...
    private void updateNewTransitionMap() {
        if (_transitionMap!=null) {
            ...
            Iterator<Map.Entry<String, String>> iter = _transitionMap.entrySet().iterator();
            while(iter.hasNext()) {
                Map.Entry<String, String> next = (Map.Entry<String, String>) iter.next();
                String[] val = next.getValue().split(":",2);
     ...
     * @return
     */
    public HashMap<String, String> getTransitionMap() { return this._transitionMap;}
     ...
     * @return
     */
    public HashMap<String, FSMTransitionInfo> getNewTransitionMap() { return this._transitions; }
